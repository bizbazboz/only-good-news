"""
CNBC RSS Feed Parser
A Python library to fetch and convert CNBC RSS feeds to JSON format.
...
class CNBCNewsParser:
    """Parser for CNBC RSS feeds using only built-in libraries."""
    
    def __init__(self, feed_url: str = "https://www.cnbc.com/id/100727362/device/rss/rss.html"):
        """
        Initialize the CNBC parser.
        
        Args:
            feed_url: The URL of the CNBC RSS feed to parse.
        """
